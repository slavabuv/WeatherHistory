...
NSString *const kDataLine    = @"";
NSString *const kCenterLine  = @"";
NSString *const kControlLine = @"";
NSString *const kWarningLine = @"";

const NSUInteger numberOfPoints = 12;
...
-(void)generateData
{
    if ( plotData == nil ) {
		...
		[contentArray addObject:[NSNumber numberWithDouble:-8]];//январь
		[contentArray addObject:[NSNumber numberWithDouble:-12]];//февраль
		[contentArray addObject:[NSNumber numberWithDouble:-10]];//март
		[contentArray addObject:[NSNumber numberWithDouble:3]];//апрель
		[contentArray addObject:[NSNumber numberWithDouble:10]];//май
		[contentArray addObject:[NSNumber numberWithDouble:12]];
		[contentArray addObject:[NSNumber numberWithDouble:14]];
		[contentArray addObject:[NSNumber numberWithDouble:12]];//август
		[contentArray addObject:[NSNumber numberWithDouble:9]];
		[contentArray addObject:[NSNumber numberWithDouble:2]];
		[contentArray addObject:[NSNumber numberWithDouble:-1]];//ноябрь
		[contentArray addObject:[NSNumber numberWithDouble:-6]];
